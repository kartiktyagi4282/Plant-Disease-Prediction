...
def predict_disease(image_path):
    ...
    with open('labels/crop_labels.json', 'r') as fp:
        dic = json.load(fp)
    ...
    json_model_path='weights/VGG16_'+crop_label_predicted+'_model.json'
    saved_weight_path='weights/vgg16_best_'+crop_label_predicted+'.hdf5'
    label_path='labels/'+crop_label_predicted+'_label.json'
